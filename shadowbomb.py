...
/___/_//_/_/ |_/____/\____/|__/|__/  
 ...
 \033[94m   │".center(columns+15))
    ...
    print("\033[94m│ \033[95mAuthor : SHADOW                    \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/ShADoWFree2009Tool \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : SHADOW             \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
